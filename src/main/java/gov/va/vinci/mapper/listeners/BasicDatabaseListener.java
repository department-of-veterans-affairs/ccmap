...
public class BasicDatabaseListener extends BaseDatabaseListener {
    ...
    protected List<Object[]> getRows(CAS aCas) {
            ...
            for (String incomingType : this.inputType) {
                ...
                if (lit.hasNext()) {
                    while (lit.hasNext()) {
                        ...
                        HashMap<String, HashSet<String>> instanceData = ListenerLogic.getInstanceData(aJCas, lit.next());
                        ...
                        if (instanceData.size() > 0) {
                            ...
                            //TODO: iterate over CUI set returned in instanceData object
        ...
        // convert this into a single record per cui
        /**/
//        HashMap<String, Object> s = new HashMap<String, Object>();
//        for (Object[] o : rowList) {
//            String cui = (String) o[3];
//            s.put(cui, o);
//        }
//        rowList = new ArrayList<>();
//        for (String b : s.keySet()) {
//            rowList.add((Object[]) s.get(b));
//        }
        /**/
        if(this.getNumReceived() % 100000 == 0 ){
            System.out.println("Processed 100,000 records");
            System.gc();
        }
    ...
    /**
     * TODO: Figure out what it is supposed to do and use it
     *
     * @param aJCas
     * @param inputType
     * @param feature
