...
import gov.va.vinci.mapper.readers.DestructiveDatabaseCollectionReader;
 ...
 * Time: 11:44
 */
public class DestructiveBatchDatabaseCollectionReader extends DestructiveDatabaseCollectionReader {
    /**
     * Min record ID.
     */
    ...
    public static DestructiveBatchDatabaseCollectionReader newReader(String driver, String url, String username,
                                                                     String password, String query,
                                                                     String idColumn, String noteColumn,
                                                                     int minRecordNumber, int maxRecordNumber, int batchSize,
                                                                     String preprocessRulesPath) {
        preprocessRules = openPreprocessRules(preprocessRulesPath);
        return new DestructiveBatchDatabaseCollectionReader(driver,url,username,password,query,idColumn,noteColumn,minRecordNumber,maxRecordNumber,batchSize);
    }
     ...
     */
    public DestructiveBatchDatabaseCollectionReader() { /** Do Nothing **/ }
     ...
     */
    public DestructiveBatchDatabaseCollectionReader(DatabaseConnectionInformation databaseConnectionInformation,
                                         DataQueryInformation dataQueryInformation,
                                         int minRecordNumber,
                                         int maxRecordNumber,
                                         int batchSize/*, String _preprocessRulesPath*/) {
        this(databaseConnectionInformation.getDriver(), databaseConnectionInformation.getUrl(),
                ...
                dataQueryInformation.getNoteColumn(), minRecordNumber, maxRecordNumber, batchSize/*, processRulesPath*/);
    }
     ...
     * @param batchSize size of each batch to retrieve at a time.  Optimal size will vary with the database environment.
     */
    public DestructiveBatchDatabaseCollectionReader(String driver, String url, String username, String password, String query,
                                         String idColumn, String noteColumn,
                                         int minRecordNumber, int maxRecordNumber, int batchSize/*, String _preprocessRulesPath*/) {
        super(driver, url, username, password, query, idColumn, noteColumn/*, processRulesPath*/);
     ...
     */
    public DestructiveBatchDatabaseCollectionReader setMinRecordNumber(int minRecordNumber) {
        this.minRecordNumber = minRecordNumber;
        return this;
    }
     ...
     * @return reference to this reader instance
     */
    public DestructiveBatchDatabaseCollectionReader setMaxRecordNumber(int maxRecordNumber) {
        this.maxRecordNumber = maxRecordNumber;
        return this;
    }
     ...
     * @return reference to this reader instance
     */
    public DestructiveBatchDatabaseCollectionReader setBatchSize(int batchSize) {
        this.batchSize = batchSize;
        return this;
    }
     ...
     * @return reference to this reader instance
     */
    public DestructiveBatchDatabaseCollectionReader setRandomBatches(int randomBatches) {
