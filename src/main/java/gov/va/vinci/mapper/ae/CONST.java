...
public class CONST {
        ...
        public static final String NE_SUBJECT_PATIENT = "0";
        public static final String NE_SUBJECT_FAMILY_MEMBER = "1";
        public static final String NE_SUBJECT_DONOR_FAMILY_MEMBER = "2";
        public static final String NE_SUBJECT_DONOR_OTHER = "3";
        public static final String NE_SUBJECT_OTHER = "4";
        ...
        public static final String MEDICATION_MENTION_TYPE = "0";
        public static final String SIGN_SYMPTOM_MENTION_TYPE = "1";
        public static final String PROCEDURE_MENTION_TYPE = "2";
        public static final String ANOTOMICAL_SITE_MENTION_TYPE = "3";
        public static final String DISEASE_DISORDER_MENTION_TYPE = "4";
